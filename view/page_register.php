...
<div class="container">
	<div class="form-row">
		...
		<div class="col-md-6">
			...
			<input class="form-control" type="int" name="salario" required id="salario"><br>
		</div>
		...
		<div class="col-md-12">
		endereco, Nº, Bairro, Cidade - Estado: <i class="fa fa-map"></i>
		...
		<div class="col-md-12">
			...
			<input class="form-control" type="int" name="preco" required id="preco"><br>
		</div>
