...
<div class="container">
	...
	<h2 class="text-center">
		CLIENTS VIEW <i class="fa fa-list"></i>
	</h2>
		...
		<table class="table table-hover">
			<thead class="thead">
				<tr>
					...
					<th>SALARIO</th>
					<th>TELEFONE</th>
					<th>ENDERECO, Nº, BAIRRO, CIDADE - ESTADO</th>
					<th>PRODUTO</th>
					<th>PRECO</th>
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo $client['aniversario']; ?></td>
					<td><?php echo $client['salario']; ?></td>
					<td><?php echo $client['telefone']; ?></td>
					<td><?php echo $client['endereco']; ?></td>
					<td><?php echo $client['produto']; ?></td>
					<td><?php echo $client['preco']; ?></td>
					<td>
